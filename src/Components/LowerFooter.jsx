  ...
  const contact_data = [
    {
      index: 1,
      title: 'Email:',
      cu_data: ' smileavenue.pakland@gmail.com',
    },
    {
      index: 2,
      title: 'Tel:',
      ...
      <div className="lower_outer_footer_container">
        ...
        <div className="contact_us">
          <div className="wrapper_container_cu">
            ...
            >
              <address>
              Ready to schedule your appointment or have questions? Reach out to us today - we're here to help you achieve your best smile!
              </address>
            </div>
